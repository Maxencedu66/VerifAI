...
# L'extraction des features de PE est basée sur le code source de Ember afin de correspondre aux features utilisées dans le dataset 
# lui même utilisé pour entrainer le modèle.

# License:Source code in this repository is covered by the GNU Affero General Public
#License version 3 (AGPL-v3). The data files themselves that are referenced in
#the README.md and available for download are covered by the MIT License.
